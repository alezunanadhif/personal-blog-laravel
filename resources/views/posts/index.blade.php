...
@section('content')
        <a href="{{ url('posts/create') }}" class="btn btn-success">+ Buat Post</a>
        <a href="{{ url('posts/trash') }}" class="btn btn-success">Riwayat</a>
        ...
        <div class="card my-4">
            <div class="card-body">
                ...
                <a href="{{ url("posts/$p->slug/edit") }}" class="btn btn-success"><i class="fa-solid fa-pen"></i></a>
            </div>
